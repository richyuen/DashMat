    ...
    return dmc.Stack(
        ...
        children=[
            dmc.Stack(
                ...
                gap=2,
                children=[
                    DashIconify(icon="grommet-icons:optimize", width=54, color="#8b95a1"),
                    dmc.Text("Portfolio Optimization", size="xl", fw=600, mt=2),
                    dmc.Text("Choose a source to load data and start optimization.", size="sm", c="dimmed"),
                ],
            ),
            html.Div(
                                ...
                                dmc.Stack(
                                    ...
                                    children=[
                                        dmc.Button(
                                            ...
                                            size="sm",
                                            fullWidth=True,
                                            id="po-welcome-add-portfolios-peer-btn",
                                        ),
                                        dmc.Button(
                                            "Index-relative",
                                            ...
                                            size="sm",
                                            fullWidth=True,
                                            id="po-welcome-add-portfolios-index-btn",
                                        ),
                                        dmc.Button(
                                            "Alternatives",
                                            ...
                                            size="sm",
                                            fullWidth=True,
                                            id="po-welcome-add-portfolios-other-btn",
                                        ),
                                    ],
                                ),
                            ],
...
layout = dmc.Container(
    ...
    children=[
            ...
            children=[
                ...
                dmc.Group(
                    ...
                    children=[
                        ...
                        dmc.Button("Import Selected", id="po-sheet-select-ok-button", color="blue"),
                    ],
                ),
            ],
        ),
        ...
        dmc.Modal(
            ...
            children=[
                dmc.Alert(
                    id="po-portfolio-add-error-alert",
                ...
                dmc.Stack(
                    ...
                    children=[
                        dmc.Select(
                            id="po-portfolio-add-series-select",
                            label="Series",
                            data=[],
                            value=None,
                            searchable=True,
                        ...
                        dmc.Group(
                            ...
                            children=[
                                dmc.Select(
                                    id="po-portfolio-add-type-select",
                                    label="Type",
                                    data=[],
                                    value=None,
                                    clearable=False,
                                ...
                                dmc.Select(
                                    id="po-portfolio-add-benchmark-type-select",
                        ...
                        dmc.Group(
                            ...
                            children=[
                                ...
                                dmc.Button(
                                    "Delete One",
                                    id="po-portfolio-delete-row-btn",
                                    variant="outline",
                                    size="xs",
                                    color="red",
                                ...
                                dmc.Button(
                                    "Clear All",
                                    id="po-portfolio-clear-rows-btn",
                                    variant="outline",
                                    size="xs",
                                    color="red",
                                    leftSection=DashIconify(icon="tabler:trash"),
                        ...
                        dmc.Group(
                            ...
                            justify="flex-end",
                            children=[
                                dmc.Button("Cancel", id="po-portfolio-add-cancel-button", variant="outline", color="red"),
...
def po_open_portfolio_add_modal(
    ...
    if triggered_id in {"po-menu-add-portfolios-index", "po-welcome-add-portfolios-index-btn"}:
        mode = "index"
    elif triggered_id in {"po-menu-add-portfolios-other", "po-welcome-add-portfolios-other-btn"}:
        mode = "other"
    else:
        mode = "peer"
    mode_title_map = {
