...
from utils.date_range_flow import build_raw_data_metadata
...
_provider_kwargs = {"id": "mantine-provider", "children": [
    ...
    dcc.Store(id="dashmat-raw-data-metadata-store", data=None, storage_type="memory"),
...
@app.callback(
    Output("dashmat-raw-data-metadata-store", "data"),
    Input("dashmat-raw-data-store", "data"),
    Input("dashmat-original-periodicity-store", "data"),
    prevent_initial_call=False,
)
def update_raw_data_metadata(raw_data, original_periodicity):
    return build_raw_data_metadata(raw_data, original_periodicity or "daily")
