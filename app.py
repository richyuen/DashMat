...
import pandas as pd
from dash import Dash, Input, Output, State, callback, dcc, html, no_update, ALL
...
# Build format lookup
STATS_FORMAT = {name: fmt for name, fmt in STATS_CONFIG}
...
app.layout = dmc.MantineProvider(
    children=[
        dmc.Container(
            ...
            py="xl",
            children=[
                dmc.Title("DashMat", order=1, mb="md"),
                dmc.Text(
